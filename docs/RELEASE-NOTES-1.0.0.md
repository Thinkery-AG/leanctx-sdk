...
Preview: local Workspace, Checkpoint, Fork, Delta, and Handoff APIs under
`leanctx_sdk.preview`. Preview may change before Stable promotion.

Not shipped: Cloud, Receipt Board, governed optimization, production AutoTune,
...
written Thinkery AG agreement. Publication remains gated by the exact final
artifact and human authorization packet.
